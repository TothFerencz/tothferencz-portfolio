            ...
            <span :key="theme">
              <svg v-if="theme === 'light'" id="light" width="20" height="20" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0)">
                  <path d="M7.75 10.25C9.54493 10.25 11 8.79493 11 7C11 5.20507 9.54493 3.75 7.75 3.75C5.95507 3.75 4.5 5.20507 4.5 7C4.5 8.79493 5.95507 10.25 7.75 10.25Z" stroke="#000001" stroke-linecap="round" stroke-linejoin="round"/>
                  ...
                  <path d="M12.35 2.3999L11.64 3.1099" stroke="#000001" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M3.85999 10.8899L3.14999 11.5999" stroke="#000001" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M12.35 11.5999L11.64 10.8899" stroke="#000001" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M3.85999 3.1099L3.14999 2.3999" stroke="#000001" stroke-linecap="round" stroke-linejoin="round"/>
                </g>
                <defs>
                  <clipPath id="clip0">
